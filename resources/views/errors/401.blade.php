...
<body class="min-h-screen flex flex-col items-center justify-center px-6 md:px-8 py-8 relative text-on-surface">
    ...
    <div class="relative z-10 text-center max-w-lg">
        <div class="text-[120px] md:text-[160px] font-headline-lg leading-none text-error tracking-tight">401</div>
        <div class="-mt-4 mb-6 w-20 h-2 bg-error mx-auto"></div>
        <p class="font-body-md text-lg text-on-surface-variant mb-8">Kamu perlu login untuk mengakses halaman ini.</p>

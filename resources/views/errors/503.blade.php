...
<body class="min-h-screen flex flex-col items-center justify-center px-6 md:px-8 py-8 relative text-on-surface">
    ...
    <div class="fixed inset-0 pointer-events-none z-0">
        ...
        <div class="absolute bottom-32 right-16 w-6 h-6 bg-tertiary-fixed border-3 border-on-background rotate-45 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hidden md:block anim-float"></div>
        <div class="absolute top-1/3 left-8 w-5 h-5 bg-tertiary-container border-3 border-on-background rounded-full -rotate-3 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hidden lg:block anim-wobble"></div>
    ...
    <div class="relative z-10 text-center max-w-lg">
        <div class="text-[120px] md:text-[160px] font-headline-lg leading-none text-tertiary tracking-tight">503</div>
        <div class="-mt-4 mb-6 w-20 h-2 bg-tertiary mx-auto"></div>
        <p class="font-body-md text-lg text-on-surface-variant mb-8">Layanan sedang dalam perawatan. Coba lagi beberapa saat.</p>

...
<body class="min-h-screen flex flex-col items-center justify-center px-6 md:px-8 py-8 relative text-on-surface">
    ...
    <div class="fixed inset-0 pointer-events-none z-0">
        <div class="absolute top-12 left-12 w-8 h-8 bg-secondary border-3 border-on-background rotate-12 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hidden md:block anim-float"></div>
        <div class="absolute top-20 right-20 w-10 h-10 bg-tertiary-fixed-dim border-3 border-on-background rounded-full -rotate-6 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hidden md:block anim-float-delayed"></div>
    ...
    <div class="relative z-10 text-center max-w-lg">
        <div class="text-[120px] md:text-[160px] font-headline-lg leading-none text-secondary tracking-tight">419</div>
        <div class="-mt-4 mb-6 w-20 h-2 bg-secondary mx-auto"></div>
        <p class="font-body-md text-lg text-on-surface-variant mb-8">Sesi login kamu telah habis. Silakan login kembali.</p>

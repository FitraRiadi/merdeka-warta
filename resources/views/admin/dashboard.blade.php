...
@section('content')
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
        <div class="admin-card stat-card stat-card-blue p-4 md:p-5">
            <div class="flex items-center justify-between mb-3">
                ...
                <span class="w-9 h-9 bg-gradient-to-br from-primary to-primary-fixed-dim border-2 border-on-background flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div class="admin-card stat-card stat-card-green p-4 md:p-5">
            <div class="flex items-center justify-between mb-3">
                ...
                <span class="w-9 h-9 bg-gradient-to-br from-green-600 to-green-300 border-2 border-on-background flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div class="admin-card stat-card stat-card-orange p-4 md:p-5">
            <div class="flex items-center justify-between mb-3">
                ...
                <span class="w-9 h-9 bg-gradient-to-br from-orange-600 to-amber-300 border-2 border-on-background flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
        ...
        @if(Auth::user()->isSuperAdmin())
            <div class="admin-card stat-card stat-card-pink p-4 md:p-5">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="w-9 h-9 bg-gradient-to-br from-secondary to-secondary-fixed-dim border-2 border-on-background flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
            ...
            <div class="admin-card stat-card stat-card-purple p-4 md:p-5">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="w-9 h-9 bg-gradient-to-br from-purple-600 to-purple-300 border-2 border-on-background flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
            ...
            <div class="admin-card stat-card stat-card-teal p-4 md:p-5">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="w-9 h-9 bg-gradient-to-br from-teal-600 to-teal-300 border-2 border-on-background flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="admin-card overflow-hidden">
            <div class="border-b-3 border-on-background bg-gradient-to-r from-primary-fixed-dim/20 to-transparent px-5 py-4 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <span class="w-7 h-7 bg-gradient-to-br from-primary to-primary-fixed-dim border-2 border-on-background flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
        ...
        @if(Auth::user()->isSuperAdmin())
            <div class="admin-card overflow-hidden">
                <div class="border-b-3 border-on-background bg-gradient-to-r from-secondary-fixed/20 to-transparent px-5 py-4 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <span class="w-7 h-7 bg-gradient-to-br from-secondary to-secondary-fixed-dim border-2 border-on-background flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
    ...
    @if(Auth::user()->isSuperAdmin() && $runningTexts->isNotEmpty())
        <div class="admin-card overflow-hidden mt-6">
            <div class="border-b-3 border-on-background bg-gradient-to-r from-purple-100/30 to-transparent px-5 py-4">
                <div class="flex items-center gap-3">
                    <span class="w-7 h-7 bg-gradient-to-br from-purple-600 to-purple-300 border-2 border-on-background flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
            ...
            <div class="p-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    @foreach($runningTexts as $rt)
                        <div class="flex items-center gap-3 p-3 border-2 border-on-background bg-gradient-to-r from-purple-50/50 to-transparent shadow-[2px_2px_0px_0px_rgba(0,0,0,0.08)]">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="font-label-mono text-[10px] text-on-surface-variant">Urutan: {{ $rt->display_order }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>

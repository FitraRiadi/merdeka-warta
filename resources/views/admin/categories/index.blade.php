...
@section('content')
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="flex flex-col h-full">
            <div class="admin-card p-5 mb-6 flex-none">
            ...
            <div class="admin-card flex-1 min-h-0 flex flex-col">
                <div class="overflow-auto flex-1 max-h-80">
                ...
                <div class="overflow-auto flex-1 max-h-80">
                    <table class="w-full admin-table">
                        <thead>
                            <tr>
                                <th class="text-left">Nama</th>
                                <th class="text-center">Jumlah Pengumuman</th>
                                <th class="text-center">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>

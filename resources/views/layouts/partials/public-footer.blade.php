    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-gutter px-4 md:px-margin-desktop py-12 w-full max-w-[1440px] mx-auto">
        <div class="space-y-6">
            ...
            <div class="flex gap-3">
                ...
                <a href="http://facebook.com/smk_merdekabdg" target="_blank" rel="noopener noreferrer" class="w-10 h-10 flex items-center justify-center brutalist-border bg-surface text-on-surface dark:bg-surface-container-high dark:text-on-surface hover:bg-blue-600 hover:text-white transition-all" title="Facebook">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://www.youtube.com/channel/UCOLjeUn3mdfIiPmS_IC3hvw" target="_blank" rel="noopener noreferrer" class="w-10 h-10 flex items-center justify-center brutalist-border bg-surface text-on-surface dark:bg-surface-container-high dark:text-on-surface hover:bg-red-600 hover:text-white transition-all" title="YouTube">
                ...
                <a href="https://www.instagram.com/smk_merdekabdg" target="_blank" rel="noopener noreferrer" class="w-10 h-10 flex items-center justify-center brutalist-border bg-surface text-on-surface dark:bg-surface-container-high dark:text-on-surface hover:bg-pink-600 hover:text-white transition-all" title="Instagram">

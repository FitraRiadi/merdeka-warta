        ...
        foreach ($blocks as $block) {
            ...
            switch ($type) {
                ...
                case 'paragraph':
                    $text = $data['text'] ?? '';
                    if ($firstParagraph) {
                        $html .= '<p class="text-xl font-bold leading-relaxed italic border-l-8 border-secondary-container pl-6 py-2 mb-6">' . e($text) . '</p>';
                ...
                case 'image':
                    ...
                    if ($url) {
                        ...
                        $html .= '<img class="w-full object-cover" src="' . e($url) . '" alt="' . e($caption ?: 'Article image') . '">';
                        if ($caption) {
